...
export default function TypeWriter() {
  ...
  return (
    <div className="w-full px-4 flex items-baseline justify-center gap-3 text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-semibold mt-3 mb-2 min-h-[1.4em]">
      <span className="text-gray-800 font-light shrink-0 leading-none">Reforma</span>
      <span
        style={{
          color: current.color,
