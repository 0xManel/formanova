    ...
    <section id="contacto" className="bg-white py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">Solicita tu presupuesto</h2>
          <div className="gold-divider mx-auto mb-6" />
          <p className="text-gray-600 max-w-lg mx-auto text-xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-gray-600 text-sm font-medium tracking-wide uppercase mb-2">Nombre</label>
              ...
              <div>
                <label className="block text-gray-600 text-sm font-medium tracking-wide uppercase mb-2">Teléfono</label>
                <input type="tel" name="telefono" value={form.telefono} onChange={handleChange} required placeholder="+34 000 000 000"
                  className="w-full bg-gray-50 border border-gray-300 focus:border-brand-gold text-gray-900 placeholder-gray-400 px-4 py-4 rounded-sm outline-none transition-colors text-lg" />
              </div>
              <div>
                <label className="block text-gray-600 text-sm font-medium tracking-wide uppercase mb-2">Mensaje</label>
              ...
              <p className="text-gray-500 text-sm text-center">Al enviar, serás redirigido a WhatsApp con tu mensaje.</p>
            </form>
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            {[
              { href: `tel:${phone}`, icon: Phone, label: "Teléfono", value: phone, sub: "Lunes–Sábado, 8–20h" },
              { href: whatsappUrl, icon: MessageCircle, label: "WhatsApp", value: phone, sub: "Respuesta rápida garantizada", external: true },
            ].map((item, i) => (
            ...
            <div className="flex items-start gap-4 bg-gray-50 border border-gray-200 p-5 rounded-sm">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-0.5">Respondemos en 24h</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-gray-50 border border-gray-200 p-5 rounded-sm">
              ...
              <div>
                <p className="text-gray-500 text-xs tracking-wide uppercase mb-1">Zona de trabajo</p>
                <p className="text-gray-900 font-semibold text-base">A Coruña</p>
                <p className="text-gray-500 text-sm mt-0.5">Y toda el área metropolitana</p>
              </div>
            </div>
            ...
            <div className="bg-brand-gold/5 border border-brand-gold/20 rounded-sm p-5">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">Visitamos la obra, evaluamos el proyecto y te enviamos un presupuesto detallado sin coste alguno.</p>
            </div>
          </div>
        </div>
      </div>
